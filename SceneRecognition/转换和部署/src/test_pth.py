...
def test():
    ...
    torch.onnx.export(model, (fake_img, img2),
                      "/home/agent/C-_Project/SceneRecognition/转换和部署/models/onnx_model/Scene.onnx", 
                      opset_version=10)
...
def check_pth_onnx():
    ...
    onnx_path = "/home/agent/C-_Project/SceneRecognition/转换和部署/models/onnx_model/a.onnx"
