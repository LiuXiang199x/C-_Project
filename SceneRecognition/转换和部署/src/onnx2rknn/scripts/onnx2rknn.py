...
RKNN_MODEL = '/home/agent/C-_Project/PTH_ONNX_RKNN/models/onnx/abc.rknn'
...
if __name__ == '__main__':
    ...
    #1806-regnet
    rknn.config(mean_values=[[123.675, 116.28, 103.53]], std_values=[[58.395, 57.12, 57.375]], reorder_channel='0 1 2', target_platform=['rv1109','rv1126'])
